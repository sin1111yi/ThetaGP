 ...
 */
/**
 * @brief This is the list of modules to be used in the HAL
 * driver
 */
...
/**
 * @brief Adjust the value of External High Speed oscillator
 * (HSE) used in your application. This value is used by the
 * RCC HAL module to compute the system frequency (when HSE
 * is used as system clock source, directly or through the
 * PLL).
 */
#if !defined(HSE_VALUE)
#define HSE_VALUE                                                              \
  (25000000UL) /*!< Value of the External oscillator in Hz                     \
                  : FPGA case fixed to 60MHZ */
#endif         /* HSE_VALUE */
 ...
 * compute the system frequency (when HSI is used as system
 * clock source, directly or through the PLL).
 */
 ...
 *        This value is used by the UART, RTC HAL module to
 ...
 *        This value is used by the I2S HAL module to
 * compute the I2S clock source frequency, this source is
 * inserted directly through I2S_CKIN pad.
 */
...
/* Tip: To avoid modifying this file each time you need to
   use different HSE,
   ===  you can define the HSE value in your toolchain
 ...
 */
/**
 * @brief Uncomment the line below to expanse the
 * "assert_param" macro in the HAL drivers code
 */
 ...
 * parameters check.
 * @param  expr: If expr is false, it calls assert_failed
 * function which reports the name of the source file and
 * the source line number of the call that failed. If expr
 * is true, it returns no value.
 * @retval None
 */
