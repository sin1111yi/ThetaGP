...
.word  _sidtcmram_data
/* start address for the .dtcmram_data section. defined in linker script */
.word  _sdtcmram_data
...
.word  _edtcmram_bss
/* start address for the initialization values of the .dtcmram_code section */
.word  _sidtcmram_code
/* start address for the .dtcmram_code section. defined in linker script */
.word  _sdtcmram_code
...
.word  _sram_data
/* end address for the .ram_data section. defined in linker script */
.word  _eram_data
/* start address for the initialization values of the .ram_d2_data section */
.word  _siram_d2_data
/* start address for the .ram_d2_data section. defined in linker script */
.word  _sram_d2_data
/* end address for the .ram_d2_data section. defined in linker script */
.word  _eram_d2_data
/* start address for the initialization values of the .ram_d3_data section */
.word  _siram_d3_data
/* start address for the .ram_d3_data section. defined in linker script */
.word  _sram_d3_data
/* end address for the .ram_d3_data section. defined in linker script */
.word  _eram_d3_data
...
/* Copy the dtcmram_data segment initializers from flash to DTCMRAM */
  ldr r0, =_sdtcmram_data
  ldr r1, =_edtcmram_data
  ldr r2, =_sidtcmram_data
  movs r3, #0
  b LoopCopyDtcmramDataInit
...
LoopCopyDtcmramDataInit:
  adds r4, r0, r3
  cmp r4, r1
  bcc CopyDtcmramDataInit

/* Copy the ram_data segment initializers from flash to RAM */
  ldr r0, =_sram_data
  ldr r1, =_eram_data
  ldr r2, =_siram_data
  movs r3, #0
...
/* Copy the ram_d2_data segment initializers from flash to RAM_D2 */
  ldr r0, =_sram_d2_data
  ldr r1, =_eram_d2_data
  ldr r2, =_siram_d2_data
  movs r3, #0
  b LoopCopyRamD2DataInit
...
LoopCopyRamD2DataInit:
  adds r4, r0, r3
  cmp r4, r1
  bcc CopyRamD2DataInit

/* Copy the ram_d3_data segment initializers from flash to RAM_D3 */
  ldr r0, =_sram_d3_data
  ldr r1, =_eram_d3_data
  ldr r2, =_siram_d3_data
  movs r3, #0
  b LoopCopyRamD3DataInit
...
LoopCopyRamD3DataInit:
  adds r4, r0, r3
  cmp r4, r1
  bcc CopyRamD3DataInit

/* Copy the dtcmram_code segment initializers from flash to DTCMRAM */
  ldr r0, =_sdtcmram_code
  ldr r1, =_edtcmram_code
  ldr r2, =_sidtcmram_code
  movs r3, #0
  b LoopCopyDtcmramCodeInit
