...
#define ATOMIC_BLOCK(prio)                                                     \
  for (uint8_t __basepri_save                                                  \
       __attribute__((__cleanup__(__basepriRestoreMem),                        \
                      __unused__)) = __get_BASEPRI(),                          \
...
#define ATOMIC_BARRIER(data)                                                   \
  ...
  __cleanup_block                                                              \
      __attribute__((cleanup(__do_cleanup), __unused__)) __UNIQL(__cleanup) =  \
          ^{                                                                   \
